...
# RACCOLTA EMAIL CON GOOGLE SHEETS (Environment Variables per Render)
st.markdown("---")
...
with st.form("newsletter_form"):
    ...
    if submitted and email:
        try:
            # Configurazione Google Sheets da Environment Variables (per Render)
            private_key_raw = os.getenv("GSHEETS_PRIVATE_KEY", "")
            # Rimuovi le virgolette esterne se presenti e sostituisci \n con veri newline
            ...
            gsheets_config = {
                ...
                "auth_provider_x509_cert_url": os.getenv("GSHEETS_AUTH_PROVIDER_CERT_URL"),
            ...
            st.info("💡 Verifica configurazione Environment Variables su Render")
